...
(function () {
  ...
  const averageDailySalesEl = document.querySelector('#averageDailySales'),
    averageDailySalesConfig = {
      ...
      series: [
        {
          data: window.dashboardData?.averageDailySales || [0, 0, 0, 0]
        }
      ],
      xaxis: {
        show: true,
  ...
  const weeklyEarningReportsEl = document.querySelector('#weeklyEarningReports'),
    weeklyEarningReportsConfig = {
      ...
      series: [
        {
          data: window.dashboardData?.weeklyEarnings || [40, 65, 50, 45, 90, 55, 70]
        }
      ],
      legend: {
        show: false
      ...
      xaxis: {
        categories: window.dashboardData?.weeklyLabels || ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su'],
        axisBorder: {
          show: false
        },
        axisTicks: {
  ...
  const supportTrackerEl = document.querySelector('#supportTracker'),
    supportTrackerOptions = {
      series: window.dashboardData?.supportTracker?.series || [0],
      labels: window.dashboardData?.supportTracker?.labels || ['Completed Orders'],
      chart: {
        height: 337,
        type: 'radialBar'
      },
  ...
  const totalEarningChartEl = document.querySelector('#totalEarningChart'),
    totalEarningChartOptions = {
      ...
      series: [
        {
          name: 'Earning',
          data: window.dashboardData?.totalEarning?.earnings || [1, 1, 1, 1, 1, 1, 1, 1]
        },
        {
          name: 'Expense',
          data: window.dashboardData?.totalEarning?.expenses || [-1, -1, -1, -1, -1, -1, -1, -1]
        }
      ],
      tooltip: {
        enabled: false
