...
class ProductDefinitionDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<ProductDefinition> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function ($q) {
                ...
                $toggleUrl = route('product_definitions.toggle-active', $q->id);
            ...
            ->addColumn('action', function ($branch) {
                $editUrl = route('product_definitions.edit', $branch->id);
                $deleteUrl = route('product_definitions.destroy', $branch->id);
                return '
                <div class="dropdown">
     ...
     */
    public function query(ProductDefinition $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('unit')->title(__('admin.unit'))->addClass('text-start'),
    ...
    {
        return 'Product Definition ' . date('Y-m-d');
    }
