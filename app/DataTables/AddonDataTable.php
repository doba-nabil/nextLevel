...
class AddonDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function ($q) {
                ...
                $toggleUrl = route('addons.toggle-active', $q->id);
            ...
            ->addColumn('addon_group', function ($branch) {
                return $branch->group->getTranslation('name', app()->getLocale());
            })
            ->addColumn('prices', function ($addon) {
                return $addon->prices->map(function ($price) {
                    return  $price->price . ' ' . $price->currency->sign;
                })->implode('<br>');
            })
            ->addColumn('action', function ($branch) {
                $editUrl = route('addons.edit', $branch->id);
                $deleteUrl = route('addons.destroy', $branch->id);
                return '
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            ->rawColumns(['action', 'prices', 'status'])
            ->setRowId('id')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('prices')->title(__('admin.price'))->addClass('text-start'),
            Column::make('addon_group')->title(__('admin.addon_group'))->addClass('text-start'),
