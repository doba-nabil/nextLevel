...
class BoxDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function ($q) {
                ...
                $toggleUrl = route('boxes.toggle-active', $q->id);
            ...
            ->addColumn('action', function ($product) {
                $editUrl = url('/admin/boxes/' . $product->id . '/edit');
                $deleteUrl = url('/admin/boxes/' . $product->id);
        ...
        <div class="dropdown">
            ...
            ->rawColumns(['name', 'action', 'status', 'availability'])
            ->setRowId('id')
    ...
    {
        return $model->where('product_type', 'box')
