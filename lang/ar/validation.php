...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'product_addons.*.*.id' => 'addon',
        'product_addons.*.*.type' => 'addon type',
        'definitions' => 'definitions',
        'definitions.*.id' => 'definition',
        'definitions.*.value' => 'definition value',
        'prices.*.before' => 'price before discount',
        'prices.*.after' => 'price after discount',
        'image' => 'image',
    ],
