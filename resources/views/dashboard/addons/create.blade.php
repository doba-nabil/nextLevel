...
@section('title', __('admin.create') .' . ' .__('admin.additionals'))
...
@section('dashboard-main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">{{ __('admin.create') .' . ' .__('admin.additionals') }}</h5>
                    <div class="card-body">
                        <form id="formValidationExamples" class="row g-6" method="POST"
                                    ...
                                    <select id="addon_group_id" class="form-select select2" name="addon_group_id">
                                        ...
                                        @foreach ($addon_groups as $group)
                                            <option value="{{ $group->id }}"
                                                {{ old('addon_group_id') == $group->id ? 'selected' : '' }}>
                            ...
                            @else
                                <h6 class="alert alert-warning text-center">{{ __('admin.please_add_currency') }}</h6>
                            @endif
                        </form>
                    </div>
                </div>
