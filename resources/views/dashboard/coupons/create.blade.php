...
@section('title', __('admin.create') .' '. __('admin.coupon'))
...
@section('dashboard-main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">{{ __('admin.create') .' '. __('admin.coupon') }}</h5>
                    <div class="card-body">
                        <form id="mealForm" class="row g-3" method="POST" action="{{ route('coupons.store') }}">
                            @csrf
                            <div class="col-md-6 mt-3">
                                ...
                                <select id="types" name="type" class="form-select select2">
                                    ...
                                    <option
                                        value="percent" {{ 'percent' == old('type') ? 'selected' : '' }}>
                                        {{ __('admin.percent') }}</option>
                                    <option
                                        value="fixed" {{ 'fixed' == old('type') ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" class="form-control" placeholder="Amount"
                                           name="value"
                                           value="{{ old("value") }}" aria-label="Amount">
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" min="1" step="1" name="usage_limit" value="{{ old('usage_limit') }}" class="form-control">
                                @error('usage_limit')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" min="1" step="1" name="min_order_price" value="{{ old('min_order_price') }}" class="form-control">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="expire_at" value="{{ old('expire_at') }}" class="form-control">
                                @error('expire_at')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
