...
@section('title', __('admin.create') .' . '. __('admin.additional_types'))
...
@section('dashboard-main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">{{ __('admin.create') .' '. __('admin.additional_types') }}</h5>
                    <div class="card-body">
                        <form id="formValidationExamples" class="row g-6" method="POST"
                              action="{{ route('addon_groups.store') }}">
                            @csrf
                            ...
                            <div class="col-md-6" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old("max_items", 0) }}" type="number" step="1" min="0" max="100" class="form-control" name="max_items"
                                ...
                                <div class="form-group">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_selection_mandatory" 
                                               name="is_selection_mandatory" value="1" {{ old('is_selection_mandatory') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old("max_selections") }}" type="number" step="1" min="1" class="form-control" name="max_selections"
                            ...
                            <div class="col-md-6" id="min_selections_row" style="display: none;">
                                <div class="form-group">
                                    <label class="form-label">{{ __('admin.minimum_number_of_selections') }}</label>
                                    <input value="{{ old("min_selections") }}" type="number" step="1" min="1" class="form-control" name="min_selections"
