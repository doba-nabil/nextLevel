...
@section('title', __('admin.create') .' '. __('admin.offer'))
...
@section('dashboard-main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">{{ __('admin.create') .' '. __('admin.offer') }}</h5>
                    <div class="card-body">
                        <form id="offerForm" class="row g-6" method="POST"
                            ...
                            <div class="col-md-6">
                                ...
                                <input value="{{ old('discount_value') }}" type="number" step="0.01" min="0" class="form-control" name="discount_value"
                            ...
                            <div class="col-md-6">
                                ...
                                <input value="{{ old('start_date') }}" type="datetime-local" class="form-control" name="start_date">
                                @error('start_date')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input value="{{ old('end_date') }}" type="datetime-local" class="form-control" name="end_date">
                                @error('end_date')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
