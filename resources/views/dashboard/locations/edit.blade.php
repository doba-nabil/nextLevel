...
@section('title', __('admin.edit') . ' . ' .$location->name)
...
@section('dashboard-main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header"> {{ __('admin.edit') . '  ' .$location->name }}</h5>
                    <div class="card-body">
                        <form id="formValidationExamples" class="row g-6" method="POST"
                              action="{{ route($type.'.update' , $location->id) }}">
                            @csrf
                            @method('PUT')
                            <input name="type" value="{{$location->type}}" hidden=""/>
                                    ...
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input value="{{$location->getTranslation('name', $localeCode)}}"
                            ...
                            @if($type == 'states')
                                <div class="form-group">
                                    ...
                                    <select id="countries" class="select2 form-control" name="parent_id" style="width:100%;">
                                        <option value="">{{ __('admin.select_parent') }}</option>
                                        @foreach ($countries as $country)
                                            <option value="{{ $country->id }}"
                                                {{ $location->parent_id == $country->id ? 'selected' : '' }}>
                                                {{ $country->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            @if($type == 'cities')
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="countries" class="select2 form-control" style="width:100%;">
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}"
                                                    {{ $location->parent->parent_id == $country->id ? 'selected' : '' }}>
                                                    {{ $country->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="states" class="select2 form-control" name="parent_id" style="width:100%;">
                                                <?php $states = \App\Models\Location::where('type', 'state')->where('parent_id', $location->parent->parent_id)->get(); ?>
                                            @foreach ($states as $state)
                                                <option value="{{ $state->id }}"
                                                    {{ $location->parent_id == $state->id ? 'selected' : '' }}>
                                                    {{ $state->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('shipping_fee_near' , $location->shipping_fee_near) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('shipping_fee_far', $location->shipping_fee_far) }}"
                                               type="number" min="0" step="0.1" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('min_order_near', $location->min_order_near) }}"
                                               type="number" min="0" step="0.1" class="form-control"
                                               name="min_order_near"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('min_order_far', $location->min_order_far) }}"
                                               type="number" min="0" step="0.1" class="form-control"
                                               name="min_order_far"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('delivery_time', $location->delivery_time) }}"
                            ...
                            @if($type == 'countries')
                                <div class="row g-3 mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone_code" value="{{ old('phone_code', $location->phone_code) }}"
                                                   placeholder="+966">
                                            @error('phone_code')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <hr>
                                <h5 class="card-header m-0 p-0 text-center">{{  __('admin.currencies') }}</h5>
                                    ...
                                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-12">
                                                    <label class="form-label">{{ __('admin.name') }}</label>
                                                    <input value="{{$location->currency?->getTranslation('name', $localeCode)}}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('sign' , $location->currency?->sign ) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('minimum_usable_points' , $location->currency?->minimum_usable_points ) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('rate_per_point' , $location->currency?->rate_per_point ) }}"
                                               type="number" min="0" step="0.1" class="form-control"
                                               name="rate_per_point"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('points_per_currency' , $location->currency?->points_per_currency ) }}"
                                               type="number" min="0" step="0.1" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="active" class="select2 form-control" name="active"
                                            style="width:100%;">
                                        <option {{ $location->active ? 'selected' : '' }} value="1">{{ __('admin.active') }}</option>
                                        <option {{ !$location->active ? 'selected' : '' }} value="0">{{ __('admin.deactive') }}</option>
                                    </select>
                                    @error('active')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                        ...
                        if(tabPane){
                            ...
                            if(tabTrigger){
                                ...
                                Swal.fire({
                                    ...
                                    text: ` {{ __('admin.validation_error_lang') }} "${tabName}"`,
