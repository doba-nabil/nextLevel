...
@section('dashboard-main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">{{ __('admin.edit') . ' ' . $product->name }}</h5>
                    <div class="card-body">
                        <form id="productForm" class="row g-6" method="POST"
                            ...
                            @csrf
                            @method('PUT')
                            <input value="product" name="product_type" hidden/>
                                    ...
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input value="{{ old("name.$localeCode", $product->getTranslation('name', $localeCode)) }}"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea rows="10" class="form-control"
                                                          ...
                                                          placeholder="{{ __('admin.description') }}">{{ old("description.$localeCode", $product->getTranslation('description', $localeCode)) }}</textarea>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <select class="form-select" name="type" id="productType">
                                    <option value="pickup" {{ old('type', $product->type) == 'pickup' ? 'selected' : '' }}>Pickup</option>
                                    <option value="delivery" {{ old('type', $product->type) == 'delivery' ? 'selected' : '' }}>Delivery</option>
                                    <option value="both" {{ old('type', $product->type) == 'both' ? 'selected' : '' }}>Both</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <select id="is_pickup" class="select2 form-control" name="is_pickup"
                                            style="width:100%;">
                                        <option value="0" {{ old('is_pickup', $product->is_pickup ?? false) ? '' : 'selected' }}>{{ __('admin.no') }}</option>
                                        <option value="1" {{ old('is_pickup', $product->is_pickup ?? false) ? 'selected' : '' }}>{{ __('admin.yes') }}</option>
                                    </select>
                                    @error('is_pickup')
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <select id="is_trending" class="select2 form-control" name="is_trending"
                                            style="width:100%;">
                                        <option value="0" {{ old('is_trending', $product->is_trending ?? false) ? '' : 'selected' }}>{{ __('admin.no') }}</option>
                                        <option value="1" {{ old('is_trending', $product->is_trending ?? false) ? 'selected' : '' }}>{{ __('admin.yes') }}</option>
                                    </select>
                                    @error('is_trending')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <select id="is_new_plates" class="select2 form-control" name="is_new_plates"
                                            style="width:100%;">
                                        <option value="0" {{ old('is_new_plates', $product->is_new_plates ?? false) ? '' : 'selected' }}>{{ __('admin.no') }}</option>
                                        <option value="1" {{ old('is_new_plates', $product->is_new_plates ?? false) ? 'selected' : '' }}>{{ __('admin.yes') }}</option>
                                    </select>
                                    @error('is_new_plates')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <select id="show_in_limit_offer" class="select2 form-control" name="show_in_limit_offer"
                                            style="width:100%;">
                                        <option value="0" {{ old('show_in_limit_offer', $product->show_in_limit_offer ?? false) ? '' : 'selected' }}>{{ __('admin.no') }}</option>
                                        <option value="1" {{ old('show_in_limit_offer', $product->show_in_limit_offer ?? false) ? 'selected' : '' }}>{{ __('admin.yes') }}</option>
                                    </select>
                                ...
                                <select id="select2Multiple" class="select2 form-select" name="branches[]" multiple>
                                    @foreach($branches as $branch)
                                        <option value="{{ $branch->id }}"
                                            {{ in_array($branch->id, old('branches', $product->branches->pluck('id')->toArray())) ? 'selected' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mt-3">
                                                ...
                                                <select class="form-control discount-type"
                                                    ...
                                                    <option
                                                        value="none" {{ old("prices.$currency->id.discount_type", optional($product->prices->where('currency_id', $currency->id)->first())->discount_type) == 'none' ? 'selected' : '' }}>
                                                        {{ __('admin.no_discount') }}
                                                    </option>
                                                    <option
                                                        value="fixed" {{ old("prices.$currency->id.discount_type", optional($product->prices->where('currency_id', $currency->id)->first())->discount_type) == 'fixed' ? 'selected' : '' }}>
                                                        {{ __('admin.fixed') }}
                                                    </option>
                                                    <option
                                                        value="percentage" {{ old("prices.$currency->id.discount_type", optional($product->prices->where('currency_id', $currency->id)->first())->discount_type) == 'percentage' ? 'selected' : '' }}>
                                                        {{ __('admin.percent') }}
                                                    </option>
                                                </select>
                                            ...
                                            <div class="col-md-4 mt-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.01" min="0" class="form-control"
                                                           ...
                                                           value="{{ old("prices.$currency->id.before", optional($product->prices->where('currency_id', $currency->id)->first())->price) }}">
                                            ...
                                            <div class="col-md-4 mt-3 discount-field discount-fixed-{{ $currency->id }}"
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.01" min="0" class="form-control"
                                                           ...
                                                           value="{{ old("prices.$currency->id.after", optional($product->prices->where('currency_id', $currency->id)->first())->discount_price) }}">
                                                    <span class="input-group-text">{{ $currency->sign }}</span>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="1" min="0" max="100"
                                                           ...
                                                           value="{{ old("prices.$currency->id.discount_percentage", optional($product->prices->where('currency_id', $currency->id)->first())->discount_percentage) }}">
                            ...
                            @if(count($addon_groups) > 0)
                                ...
                                <div class="col-md-12">
                                    @php
                                        $selectedAddons = old('addons', $product->addons->map(function($a){ 
                                            return [
                                                'id' => $a->id,
                                                                ...
                                                                @foreach($group->addons as $addon)
                                                                    ...
                                                                    <div class="row mb-2 align-items-center addon-item-in-group-block" data-addon-id="{{ $addon->id }}" data-addon-group-id="{{ $addon->addon_group_id }}">
                                                                        ...
                                                                        <div class="col-md-3" style="display: none;">
                                                                            <label class="form-label mb-1 small">{{ __('admin.type') }}</label>
                        ...
                        @if(count($definitions) > 0)
                                ...
                                <div class="col-md-12 mt-3">
                                    <div id="definitions-wrapper">
                                        @foreach(old('definitions', $product->properties->map(function($p){ return ['id'=>$p->id,'value'=>$p->pivot->value]; })->toArray()) as $index => $definition)
                                            <div class="row g-2 mb-2">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="number" step="0.1" min="0" max="100000"
                                                           name="definitions[{{$index}}][value]" class="form-control definition-value-input"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="active" class="select2 form-control" name="active"
                                            style="width:100%;">
                                        <option {{ $product->active ? 'selected' : '' }} value="1">{{ __('admin.active') }}</option>
                                        <option {{ !$product->active ? 'selected' : '' }} value="0">{{ __('admin.deactive') }}</option>
                                    </select>
                                    @error('active')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
...
@section('dashboard-head')
    ...
    <style>
        ...
        .addon-group-card .card-header {
            position: relative;
        }
        .addon-group-card .card-header::before {
            content: '⋮⋮';
            position: absolute;
            left: 10px;
            color: #6c757d;
        ...
        .sortable-groups .sortable-ghost {
            opacity: 0.4;
            background-color: #e9ecef;
        }
        .sortable-groups .sortable-chosen {
            background-color: #fff3cd;
        }
        .group-block {
            cursor: move;
...
@section('dashboard-footer')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            <div class="col-md-5">
                <select name="definitions[${index}][id]" class="form-select definition-select">
                    <option value=" ">  </option>
                    @foreach($definitions as $def)
                <option value="{{ $def->id }}" data-key="{{ $def->key ?? '' }}">{{ $def->name }} - {{ $def->unit }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-5">
                <input type="number" step="0.1" min="0" max="100000"
                       name="definitions[${index}][value]" class="form-control definition-value-input" placeholder="Definition value">
            </div>
            <div class="col-md-2">
                <button type="button" class="btn btn-danger remove-definition">X</button>
            </div>
        `;
                ...
                updateSelectOptions();
                updateStepForCalories();
            });

            function updateStepForCalories() {
                document.querySelectorAll('.definition-select').forEach(function(select) {
                    const input = select.closest('.row').querySelector('.definition-value-input');
                    if (input) {
    ...
    <script>
        'use strict';
        document.addEventListener('DOMContentLoaded', function () {
            @if(isset($product) && $product->getFirstMediaUrl('products'))
            initImageCropper('#dropzone-basic', 'image', null, "{{ $product->getFirstMediaUrl('products') }}");
            @else
