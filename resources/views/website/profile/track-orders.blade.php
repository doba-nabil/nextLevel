...
@section('title',  __('website.track_order') )
@section('body', false)
        ...
        <div class="container px-lg-0">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> {{ __('website.track_order') }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container container_start px-lg-0">
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                    @include('website.profile.partials.track_orders')
                </div>
            </div>
        </div>
    </section>
