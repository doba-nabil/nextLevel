...
@section('title',  __('website.add_money') )
@section('body', false)
        ...
        <div class="container px-lg-0">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('profile.wallet') }}">{{ __('website.my_wallet') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page"> {{ __('website.add_money') }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container container_start px-lg-0">
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                    @include('website.profile.partials.add_money')
                </div>
            </div>
        </div>
    </section>
